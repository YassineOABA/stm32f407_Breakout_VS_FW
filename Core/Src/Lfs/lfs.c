...
const struct lfs_config cfg = {
    ...
    .read_size      = 16,      // Read size (can be increased)
    .prog_size      = 256,     // Page size (matches flash)
    .block_size     = 4096,    // Smallest erasable unit (4KB sectors)
    .block_count    = 4096,    // Total 16MB flash (4096 × 4KB = 16MB)
    .cache_size     = 256,     // Cache size (matches prog_size)
    .lookahead_size = 128,     // Optimized lookahead buffer
    .block_cycles   = 1000,    // Wear leveling
};
